  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link " href="Controlador?accion=Carrito"><i class="fas fa-shopping-cart">(<label
                style="color: darkorange">${contador}</label>)</i>Carrito</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Controlador?accion=Mantenedor">Administración</a>
        </li>
      </ul>
        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <div class="card-footer text-center">${p.getDescripcion()}
              <div>
                <a href="Controlador?accion=AgregarCarrito&id=${p.getId()}" class="btn btn-outline-info">Agregar al
                  carrito</a>
